    ...
    <div className="textPage">
      ...
      <div className="textBlock">
        ...
        <ul>
          ...
          <li>
            <p><strong>Website</strong> refers to Cryptopixels, accessible from <a href="https://cryptopixels.org" rel="external nofollow noopener" target="_blank">https://cryptopixels.org</a></p>
          </li>
          <li>
